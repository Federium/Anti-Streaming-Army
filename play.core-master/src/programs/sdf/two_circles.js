...
import { sdCircle, opSmoothUnion } from '/play.core-master/src/modules/sdf.js'
import { sub, vec2 } from '/play.core-master/src/modules/vec2.js'
...
export function main(coord, context, cursor, buffer) {
	...
	const c = 1.0 - Math.exp(-5 * Math.abs(d2))
